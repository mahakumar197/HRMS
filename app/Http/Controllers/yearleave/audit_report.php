...
class audit_report extends Controller
{
    ...
    public function index(Request $request){
        ...
        if ($request->from_date == '') {
             ...
             return view('report.audit.index');
         }
         ...
         if ($request->from_date != '' && $request->to_date != '') {
          ...
          $id = Auth::id();
            ...
            ->whereDate('ml_to_date','!=','null')->select('id','name','ml_from_date','ml_to_date')->orderBy('joining_date','ASC')->get();
            ...
            foreach ($data['employee_info'] as $sl => $v_employee) {
                ...
                if($pending_leave != null ){
                   ...
                   return redirect()->back()->with('message', 'Pending Leave Application Found');
                                ...
                                $data['details'][$v_employee->id]  = $this->leave_record_service->getcl($v_employee->id,$from_month, $to_month,$v_employee->name,$v_employee->joining_date,$v_employee->employee_code,$relieved_employee,$year,$to_year);
        ...
        return view('report.audit.index', compact('employee_info', 'data', 'from','year','relieved_employee','to','ml_employee'));
