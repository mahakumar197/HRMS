...
class sickleaveController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            $employee = LeaveEntitlement::with('user', 'leaveType')->where('leave_type_id', '=', '3')->select('user_id', 'leave_type_id', 'entitlement', 'id')->get();

            return datatables($employee)
                ->addIndexColumn()
                ->addColumn('action', function ($row) {

                    $action = '<a  href=" sickleave/' . $row->id . '/edit "><svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 24 24" 
        ...
        return view('entitlement.sickleave.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('entitlement.sickleave.edit', compact('employee'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('sickleave.index')->with('message', 'Entitlement Updated Successfully.');
    }
