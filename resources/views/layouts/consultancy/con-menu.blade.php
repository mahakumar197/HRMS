<ul class="sidebar-links" id="simple-bar">
    <li class="back-btn"><a href="{{url('consultancy/home')}}"><img class="img-fluid" src="{{ asset('assets/css/images/logo-icon.png') }}" alt=""></a>
        <div class="mobile-back text-end"><span>Back</span><i class="fa fa-angle-right ps-2" aria-hidden="true"> </i></div>
    </li>
    <li class="sidebar-list"><a class="sidebar-link link-nav sidebar-title" href="{{url('consultancy/home')}}">
    ...
    <!--<li class="sidebar-list"><a class="sidebar-link link-nav sidebar-title" href="{{url('consultancy/referral')}}">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g>
                    <g>
                        <path d="M9.07861 16.1355H14.8936" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
    ...
    <li class="sidebar-list"><a class="sidebar-link link-nav sidebar-title" href="{{url('consultancy/candidate')}}">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g>
                    <g>
