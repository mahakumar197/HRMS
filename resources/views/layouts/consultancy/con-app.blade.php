          ...
          <nav class="sidebar-main">
            ...
            <div id="sidebar-menu">
              ...
              <div class="sidebar-img-section">
                <div class="sidebar-img-content"><img class="img-fluid" src="{{asset('assets/css/images/side-bar.png')}}" alt="">
                  <h4>Need Help ?</h4><a class="txt" href="#">Contact HR Team at "test@test.com"</a><a class="btn btn-secondary" href="mailto:test@test.com">Mail Us</a>
                </div>
              </div>
