  ...
  <div class="page-wrapper compact-wrapper" id="pageWrapper">
          ...
          <ul class="nav-menus">
            ...
            <li class="profile-nav onhover-dropdown pe-0 py-0 me-0">
              <div class=" media d-flex align-items-center">
                <div class="media-body me-3 text-end lh-1 text-dark align-items-center d-none d-lg-block"><span class="mb-0 font-small text-gray-900 text-capitalize">{{ Auth::guard('consultancy')->user()->consultancy_name }}</span><br></div>
                <img class="avatar rounded-circle" alt="Image placeholder" src="https://eu.ui-avatars.com/api/?name={{urlencode(Auth::guard('consultancy')->user()->consultancy_name)}}&background=random">


              </div>

              <ul class="profile-dropdown onhover-show-div">
                <li><a href="{{url('consultancy/change-password')}}"><i data-feather="settings"></i><span>Settings</span></a>
                </li>
                <li><a href="{{ route('consultancy.consultancy.logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i data-feather="log-out"> </i><span>Log out</span></a></li>
                <form id="logout-form" action="{{ route('consultancy.consultancy.logout') }}" style="display:none;" method="POST"> @csrf</form>
              </ul>
            </li>
          </ul>
        </div>
    ...
    <div class="page-body-wrapper">
      ...
      <div class="sidebar-wrapper">
        <div>
          <div class="logo-wrapper"><a href="{{url('/dashboard')}}"><img class="img-fluid for-light" src="{{ asset('assets/css/images/logo/small-logo.png') }}" alt=""><img class="img-fluid for-dark" src="{{asset('assets/css/images/logo/sword-logo.png')}}" alt=""></a>
            <div class="back-btn"><i class="fa fa-angle-left"></i></div>
          </div>
          <div class="logo-icon-wrapper"><a href="{{url('/dashboard')}}"><img class="img-fluid" src="{{ asset('assets/images/logo-icon.png') }}" alt=""></a></div>
          <nav class="sidebar-main">
            <div class="left-arrow" id="left-arrow"><i data-feather="arrow-left"></i></div>
            <div id="sidebar-menu">
              @include('layouts.consultancy.con-menu')
              <div class="sidebar-img-section">
                <div class="sidebar-img-content  bg-success"><img class="img-fluid" src="{{asset('assets/css/images/side-bar.png')}}" alt="">
                <h4>Need Help ?</h4><a class="txt" href="#">Contact HR Team at "test@test.com"</a><a class="btn btn-light" href="mailto:test@test.com">Mail Us</a>
                </div>
              </div>
