...
@section('page_title')
<title>Edit Privilege Leave Entitlement</title>
@endsection
    ...
    <div class="page-title">
      <div class="row">
        <div class="col-12 col-sm-6">
          <h3>
            Edit Privilege Leave Entitlement</h3>
        </div>
        <div class="col-12 col-sm-6">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="form theme-form projectcreate">
              <form action="{{url ('privilegeleave/'.$employee->id) }}" method="POST" autocomplete="off">
                @csrf
                @method('PUT')
                @method('PUT')
                <div class="row">
                ...
                <div class="row">
                  <div class="col">
                    <div class="text-right"> <button class="btn btn-primary me-3" type="submit">Update </button><a href="{{route('privilegeleave.index')}}" class="btn btn-secondary me-3">Cancel</a></div>
                  </div>
                </div>
              </form>
            </div>
