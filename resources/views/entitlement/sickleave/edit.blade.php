        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="form theme-form projectcreate">
              <form action="{{url ('sickleave/'.$employee->id) }}" method="POST" autocomplete="off">
                @csrf
                @method('PUT')
                @method('PUT')
                <div class="row">
                ...
                <div class="row">
                  <div class="col">
                    <div class="text-right"> <button class="btn btn-primary me-3" type="submit">Update </button><a href="{{route('sickleave.index')}}" class="btn btn-secondary me-3">Cancel</a></div>
                  </div>
                </div>
              </form>
            </div>
