              ...
              <form action="{{ url ('employee') }}" method="POST" enctype="multipart/form-data" id="emp" autocomplete="off">
                  ...
                  <!-- <div class="col-sm-6">
                    <div class="mb-3">
                      ...
                      <div class="input-group">
                        <input class="form-control {{ $errors->has('password') ? ' has-error' : ''}}" name="password" type="password" placeholder="Password" id="password">
                        <div class="input-group-addon">
                          <span class="input-group-text toggle"><i class="bi bi-eye-slash" id="togglePassword"></i></span>
                        </div>
                      </div>
                  ...
                  <div class="col-sm-6">
                    <div class="mb-3">
                      ...
                      <select class="form-select" name="sub_role">
                        <option value=''>Select</option>
                        <option value="hr" {{ old('sub_role') == 'hr' ? 'selected' : '' }}>HR</option>
                      </select>
                    </div>
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="mb-3">
                      ...
                      <input class="form-control  {{ $errors->has('name') ? ' has-error' : ''}} text-uppercase" name="name" type="text" placeholder="Employee Name" value="{{old('name')}}">
                      @if ($errors->has('name'))
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="mb-3">
                      ...
                      <input class="datepicker-here form-control digits  {{ $errors->has('joining_date') ? ' has-error' : ''}}" type="text" data-position="bottom right" name="joining_date" data-date-format="dd-mm-yyyy" placeholder="DD-MM-YYYY" data-language="en" value="{{old('joining_date')}}">
                  ...
                  <div class="col-sm-6">
                    <div class="mb-3">
                      ...
                      <input class=" datepicker-here form-control digits {{ $errors->has('birth_date') ? ' has-error' : ''}}" data-position="bottom right" id='future' name="birth_date" type="text" data-date-format="dd-mm-yyyy" placeholder="DD-MM-YYYY" data-language="en" value="{{old('birth_date')}}">
                      @if (old('birth_date'))
                ...
                <div class="row">
                  <div class="col-sm-6">
                    <div class="mb-3">
                      ...
                      <input class="form-control  {{ $errors->has('res_address') ? ' has-error' : ''}}" type="text" placeholder="Address" name="res_address" id="curAddressLine1" value="{{old('res_address')}}">
                ...
                <div class="row">
                  <div class="col-sm-6">
                    <div class="mb-3">
                      <label>City*</label>
                      <input class="form-control  {{ $errors->has('res_city') ? ' has-error' : ''}}" type="text" placeholder="City" name="res_city" id="curCity" value="{{old('res_city')}}">
                ...
                <div class="row">
                  <div class="col-sm-6">
                    <div class="mb-3">
                      ...
                      <input class="form-control  {{ $errors->has('nationality') ? ' has-error' : ''}}" type="text" placeholder="Nationality" name="nationality" value="{{old('nationality')}}" id="country">
                ...
                <div class="row">
                  <div class="col-sm-6">
                    <div class="mb-3">
                      ...
                      <input class="form-control  {{ $errors->has('higest_qualification') ? ' has-error' : ''}}" type="text" placeholder="Highest Qualification" name="higest_qualification" value="{{old('higest_qualification')}}">
                ...
                <div class="row">
                  <div class="col-sm-6">
                    <div class="mb-3">
                      ...
                      <input class="form-control  {{ $errors->has('experience') ? ' has-error' : ''}}" type="text" name="experience" value="{{old('experience')}}">
                  ...
                  <div class="col-sm-6">
                    <div class="mb-3">
                      ...
                      <input class="form-control  {{ $errors->has('previous_employer') ? ' has-error' : ''}}" type="text" name="previous_employer" value="{{old('previous_employer')}}">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="mb-3">
                      ...
                      <textarea class="form-control  {{ $errors->has('skill_set') ? ' has-error' : ''}}" id="exampleFormControlTextarea1" rows="3" name="skill_set">{{old('skill_set')}}</textarea>
                ...
                <div class="row">
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="text-end"><button class="btn btn-primary me-3" type="submit"> Add </button><a onclick="resetForm()" class="btn btn-danger me-3">Reset</a><a href="{{route('employee.index')}}" class="btn btn-secondary me-3">Cancel</a></div>
                    </div>
                  </div>
                  <form>
                </div>
