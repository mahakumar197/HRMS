                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="padding:0 15px; text-align:center;">
                                        <h1 style="color:#3075BA; font-weight:400; margin:0;font-size:32px;">Active Requirements from Sword</h1>
                                ...
                                <tr>
                                    <td>
                                        <table cellpadding="0" cellspacing="0" style="width: 100%; border: 1px solid #ededed">
                                            <tbody>
                                                <tr>
                                                    <td style="padding: 10px; border-bottom: 1px solid #ededed; border-right: 1px solid #ededed; width: 35%; font-weight:500; color:#171f23de">Job :</td>
                                                    <td style="padding: 10px; border-bottom: 1px solid #ededed; color: rgba(23,31,35,.87);">{{$share['name']}}</td>
                                                </tr>
                                                <tr>
                                                    <td style="padding: 10px; border-bottom: 1px solid #ededed; border-right: 1px solid #ededed; width: 35%; font-weight:500; color:#171f23de">Job Code :</td>
                                                    <td style="padding: 10px; border-bottom: 1px solid #ededed; color: rgba(23,31,35,.87);">{{$share['code']}}</td>
                                                </tr>

                                                <tr>
                                                    <td colspan="2" align="center" style="padding: 30px; border: 1px solid white; width: 35%; font-weight:500; color:#171f23de">
                                                        <a href="{{url('/consultancy/acknowledge/'.$share['id'])}}" target="_blank" style="background:#225588;color:white;padding:10px;text-decoration: none;">
                                                        Read More</a>
                                                    </td>
                                                </tr>
                                            </tbody>
