                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="padding:0 15px; text-align:center;">
                                        <h1 style="color:#3075BA; font-weight:400; margin:0;font-size:32px;">Leave Application | {{$details['leaveStatus'] == 1 ? "Approved" : "Cancelled" }} </h1>
                                ...
                                <tr>
                                    <td>
                                        <table cellpadding="0" cellspacing="0" style="width: 100%; border: 1px solid #ededed">
                                            <tbody>
                                                <tr>
                                                    <td style="padding: 10px; border-bottom: 1px solid #ededed; border-right: 1px solid #ededed; width: 35%; font-weight:500; color:#171f23de">Employee Name:</td>
                                                    <td style="padding: 10px; border-bottom: 1px solid #ededed; color: rgba(23,31,35,.87);">{{$details['name']}} {{$details['last_name']}}</td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td style="padding: 10px; border-bottom: 1px solid #ededed; color: rgba(23,31,35,.87);">{{$details['code']}}</td>
                                                </tr>
                                                <tr>
                                                    <td style="padding: 10px; border-bottom: 1px solid #ededed;border-right: 1px solid #ededed; width: 35%; font-weight:500; color:#171f23de">Leave Status:</td>
                                                    <td style="padding: 10px; border-bottom: 1px solid #ededed; color: rgba(23,31,35,.87);">{{$details['leaveStatus'] == 1 ? "Approved" : "Cancelled" }} </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td style="padding: 10px; border-bottom: 1px solid #ededed; color: rgba(23,31,35,.87);">{{$details['Leavetype']}}</td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td style="padding: 10px; border-bottom: 1px solid #ededed; color: rgba(23,31,35,.87);">{{$details['start_date']}}</td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td style="padding: 10px; border-bottom: 1px solid #ededed; color: rgba(23,31,35,.87); ">{{$details['end_date']}}</td>
                                                </tr>
                                                <tr>
                                                    <td style="padding: 10px; border-bottom: 1px solid #ededed; border-right: 1px solid #ededed; width: 35%;font-weight:500; color:#171f23de">Number of Days:</td>
                                                    <td style="padding: 10px; border-bottom: 1px solid #ededed; color: rgba(23,31,35,.87);">{{$details['no_of_days']}}</td>
                                                </tr>
                                                <tr>
                                                    <td style="padding: 10px; border-bottom: 1px solid #ededed; border-right: 1px solid #ededed; width: 35%;font-weight:500; color:#171f23de">Reason:</td>
                                                    <td style="padding: 10px; border-bottom: 1px solid #ededed; color: rgba(23,31,35,.87);">{{$details['Leave_reason']}}</td>
                                                </tr>
                                                <tr>
                                                    <td style="padding: 10px; border-bottom: 1px solid #ededed; border-right: 1px solid #ededed; width: 35%;font-weight:500; color:#171f23de">Approved By:</td>
                                                    <td style="padding: 10px; border-bottom: 1px solid #ededed; color: rgba(23,31,35,.87);">{{$details['approved_by']}}</td>

                                                </tr>

                                                <tr>
                                                    <td style="padding: 10px; border-right: 1px solid #ededed; width: 35%;font-weight:500; color:#171f23de">
                                                        Project:</td>
