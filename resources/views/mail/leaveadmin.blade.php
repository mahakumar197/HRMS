                     ...
                     <tbody>
                        ...
                        <tr>
                           <td style="padding:0 15px; text-align:center;">
                              <h1 style="color:#3075BA; font-weight:400; margin:0;font-size:32px;">Leave Application
                              </h1>
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       <td style="padding: 10px; border-bottom: 1px solid #ededed;border-right: 1px solid #ededed; width: 35%; font-weight:500; color:#171f23de">
                                          Leave Type:</td>
                                       <td style="padding: 10px; border-bottom: 1px solid #ededed; color: rgba(23,31,35,.87);">
                                          @if ($user['leave_type_id'] == '1')

                                          CL

                                          @elseif ($user['leave_type_id'] == '2')

                                          PL

                                          @elseif ($user['leave_type_id'] == '3')
                        ...
                        <tr>
                           <td colspan="2" align="center" style="padding: 30px; border: 1px solid white; width: 35%; font-weight:500; color:#171f23de">
                              <a href="{{url('/manageleave/')}}" target="_blank" style="background:#225588;color:white;padding:10px;text-decoration: none;">Leave
                                 Approval</a>
                           </td>
                        </tr>
                        <tr>
