            ...
            <table class="content" width="100%" cellpadding="0" cellspacing="0" role="presentation"
                ...
                <tr>
                    <td class="header"
                        ...
                        <img src="https://www.sword-group.com/wp-content/uploads/2021/04/sword-logo.png" class="logo"
                            alt="Laravel Logo"
                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; max-width: 100%; border: none; height: 75px; max-height: 75px; width: 200px;">
                ...
                <tr>
                    <td class="body" width="100%" cellpadding="0" cellspacing="0"
                        ...
                        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                            style="max-width:670px; background:#fff; border-radius:3px; -webkit-box-shadow:0 1px 3px 0 rgba(0, 0, 0, 0.16), 0 1px 3px 0 rgba(0, 0, 0, 0.12);-moz-box-shadow:0 1px 3px 0 rgba(0, 0, 0, 0.16), 0 1px 3px 0 rgba(0, 0, 0, 0.12);box-shadow:0 1px 3px 0 rgba(0, 0, 0, 0.16), 0 1px 3px 0 rgba(0, 0, 0, 0.12); padding:0 40px;">
                            <tbody>
                                <tr>
                                ...
                                <tr>
                                    <td style="padding:0 15px; text-align:center;">
                                        <h1 style="color:#3075BA; font-weight:400; margin:0;font-size:32px;">New
                                            Employee from HR Team
                                        </h1>
                                            ...
                                            <tr>
                                                <td class="content-cell"
                                                    ...
                                                    <h4
                                                        ...
                                                        New Employee {{$details['name']}} {{$details['last_name']}} Joined.</h4>
                                                    <p
                                                        ...
                                                        Candidate for the job <span class = "font_weight : bold">{{$details['job']}} - {{$details['project']}}</span> for position <span class = "font_weight : bold">{{$details['position']}} </span> has joined as Sword Employee, Kindly
                                                        Provide Employee Code, Email and Password to access Sword
                                                        Attendance System.</p>
                                                    ...
                                                    <table cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td
                                                                    style="padding: 10px; border-bottom: 1px solid #ededed; border-right: 1px solid #ededed; width: 35%; font-weight:500; color:#171f23de">
                                                                    Employee Name:</td>
                                                                <td
                                                                    style="padding: 10px; border-bottom: 1px solid #ededed; color: rgba(23,31,35,.87);">
                                ...
                                <tr>
                                    <td colspan="2" align="center"
                                        style="padding: 30px; border: 1px solid white; width: 35%; font-weight:500; color:#171f23de">
                                        <a href="{{url('/employee/'.$details['id'].'/edit')}}" target="_blank"
                                            style="background:#225588;color:white;padding:10px;text-decoration: none;">More Details</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="height:40px;">&nbsp;</td>
                            ...
                            <tr>
                                <td class="content-cell" align="center"
                                    ...
                                    <p
                                        ...
                                        © 2023 Sword HRM. All rights reserved.</p>
