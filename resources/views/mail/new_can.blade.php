                     ...
                     <tbody>
                        ...
                        <tr>
                           <td style="padding:0 15px; text-align:center;">
                              <h1 style="color:#3075BA; font-weight:400; margin:0;font-size:32px;">New Candidate
                              </h1>
                        ...
                        <tr>
                           ...
                           <td colspan="2" align="center" style="padding: 30px; border: 1px solid white; width: 35%; font-weight:500; color:#171f23de">
                              <a href="{{url('/candidate/')}}" target="_blank" style="background:#225588;color:white;padding:10px;text-decoration: none;">View Details</a>
                           </td>
                        </tr>
