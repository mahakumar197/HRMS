                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="padding:0 15px; text-align:center;">
                                        <h1 style="color:#3075BA; font-weight:400; margin:0;font-size:32px;">Attendance
                                            Not Marked | {{ $date }}</h1>
                                ...
                                <tr>
                                    <td align="center" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding-copy">This is a gentle reminder that you have not yet marked
                                        your attendance in the system on {{$date}}.</td>
                                </tr>
                                <tr>
                                    <td colspan="2" align="center" style="padding: 30px; border: 1px solid white; width: 35%; font-weight:500; color:#171f23de">
                                        <a href="{{url('/attendance/create')}}" target="_blank" style="background:#225588;color:white;padding:10px;text-decoration: none;">Mark
                                            Attendance</a>
                                    </td>
                                </tr>
                                <tr>
