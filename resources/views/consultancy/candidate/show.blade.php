                                ...
                                <div class="job-description">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                <label>Address</label>
                                                <input class="form-control" type="text" placeholder="Address" value="{{$candidate->address}}">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                <label>Candidate Location</label>
                                                <input class="form-control" type="text" placeholder="Location" value="{{$candidate->candidate_location}}">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                <label>Nationality</label>
                                                <input class="form-control" type="text" placeholder="Nationality" value="{{$candidate->nationality}}">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="col" id="radio-group">
