                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            type="text" data-position="bottom right" placeholder="DD-MM-YYYY" name="leave_from_date">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            type="text" data-position="bottom right" placeholder="DD-MM-YYYY" name="leave_to_date">
                                        </div>
                                    </div>
                                </div>
    ...
    $(document).ready(function() {
        ...
        function fill_datatable(leave_from_date, leave_to_date) {
            ...
            var dataTable = $('#leave_all').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('leave-report-employee') }}",
                    data: {
