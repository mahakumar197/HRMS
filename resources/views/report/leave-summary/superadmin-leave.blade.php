                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input class="datepicker-here form-control digits" id="leave_from_date" data-language="en" 
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input class="datepicker-here form-control digits" id="leave_to_date" data-language="en" 
