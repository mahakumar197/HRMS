                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input class="datepicker-here form-control digits" id="attend_from_date" type="text" required="required" data-position="bottom right" value="{{ Carbon\Carbon::now()->firstOfMonth()->format('d-m-Y') }}" placeholder="DD-MM-YYYY" name="attend_from_date">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input class="datepicker-here form-control digits" id="attend_to_date" type="text" required="required" data-position="bottom right" value="{{ Carbon\Carbon::now()->endOfMonth()->format('d-m-Y') }}" placeholder="DD-MM-YYYY" name="attend_to_date">
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="display basic-1 " id="attend_pm">
                            <thead>
                                <tr>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function fill_datatable(attend_from_date, attend_to_date) {
            ...
            var dataTable = $('#attend_pm').DataTable({

                processing: true,
                serverSide: true,
                ajax: {
                    url: "{{ route('atten-report-pm') }}",
                    data: {
