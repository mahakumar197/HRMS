@extends('layouts.app')
@section('page_title')
    <title>Leave Record Report</title>
@endsection
@section('style')
    <style>
        .al {
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form theme-form projectcreate">
                                    <form action="{{ url('year-leave-record') }}" method="POST" autocomplete="off">
                                        @csrf
                            ...
                            <div class="card-body">
                                    ...
                                    <table
                                        ...
                                        <thead>
                                            ...
                                            <td class="header" colspan="30" data-f-sz="25" data-f-color="993300" data-fill-color="c4bd97" data-a-h="center" data-a-v="middle" data-f-bold="true">
                                                <h1> LEAVE RECORD - <span id="from_month">{{ Str::upper(Carbon\Carbon::parse($from)->format(' F Y '))}} </span> -<span id="to_month">{{ Str::upper(Carbon\Carbon::parse($to)->format(' F Y '))}}</span> </h1>
                                            </td>
                                        </tr>
                                ...
                                @foreach ($data['details'] as $employee)
                                   ...
                                   <tr>
                                    ...
                                    <td  data-a-h="center" data-a-v="middle" data-f-color="FF0000" data-b-a-s="thin" data-f-bold="true"> {{ $employee['name']}}&nbsp; {{ $employee['last_name']}}</td>
                                    ...
                                    <td data-a-h="center" data-a-v="middle" data-f-color="000000" data-b-a-s="thin"> {{ $employee['name']}}&nbsp; {{ $employee['last_name']}}</td>
...
var project_name = $('#project_name').text();
    ...
    $("#export").click(function() {
        ...
        TableToExcel.convert(document.getElementById("leave-details"), {
            name: "Leave Record "+from_month+"-"+to_month +".xlsx",
            sheet: {
                name: "Sheet 1"
            }
        });
