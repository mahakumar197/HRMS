            ...
            <div class="col-xl-9 xl-60 box-col-7">
                <div class="card">
                    <div class="job-search">
                        <form class="form theme-form" action="{{url('candidate/'.$candidate->id)}}" method="POST" enctype="multipart/form-data" id='candidate' autocomplete="off">
                            @csrf
                            @method('PUT')
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="datepicker-here form-control   {{ $errors->has('dob') ? ' has-error' : ''}}" readonly type="text" data-position="top right" placeholder="DD-MM-YYYY" name="dob" value="{{Carbon::parse($candidate->dob)->format('d-m-Y')}}">
                                                @if ($errors->has('dob'))
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select {{ $errors->has('outsourced_via') ? ' has-error' : ''}}" name="outsourced_via">
                                                    ...
                                                    <option value="Consultancy" {{$candidate->outsourced_via == 'Consultancy'  ?'selected ':'' }}>Consultancy</option>
                                                    <option value="Employee Referral" {{$candidate->outsourced_via == 'Employee Referral'  ?'selected ':'' }}>Employee Referral</option>
                                                    <option value="Naukri" {{$candidate->outsourced_via == 'Naukri'  ?'selected ':'' }}>Naukri</option>
                                                </select>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select {{ $errors->has('recruiter_name') ? ' has-error' : ''}}" name="recruiter_name">
                                                    <option value=''>Select</option>
                                                    @foreach ($hr as $hr)
                                                    <option value="{{$hr->id}}" {{$hr->id == $candidate->recruiter_name  ?'selected':''}}>{{ $hr->name}} {{ $hr->last_name}}</option>
                                                    @endforeach
                                                </select>
