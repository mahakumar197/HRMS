...
<div class="page-body">
                ...
                <div class="col-12 col-sm-6">
                    <ol class="breadcrumb">
                        <div class="btn-showcase">
                            ...
                            <button class="btn btn-outline-primary nav-toggle" type="button" href="#collapse1" data-bs-original-title="" title="" data-original-title="btn btn-info">Show Organization Dashboard</button>
                        </div>
                    </ol>
                </div>
            </div>
    ...
    <div class="section" id="collapse1" style="display:none">
        <div class="container-fluid crypto-dash">
            <div class="row">
                ...
                <div class="col-xl-3 col-md-6 col-12">
                    <div class="card card-absolute">
                        <div class="card-header bg-primary">
                            <h5 class="text-white">Employee Leaves By Projectwise</h5>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($project_lists as $proj)
                                        <tr>
                                            @foreach($emp_leave as $key => $emp_leaves)

                                            @if($proj->id == $key)

                                            @if(count($emp_leaves) > 0)
                                            <td>
                                                <h5 class="mb-0 text-uppercase">{{$proj->project_name}}</h5>
                                            </td>
                                            <td>
                                                <h5 class="mb-0 example-popover" data-bs-trigger="hover" data-container="body" data-bs-toggle="popover" data-bs-placement="top" title="" data-offset="-20px -20px" data-bs-content="@foreach($emp_leaves as $emp )

                                                @if($emp->user != null)
                                               {{$emp->user->name}},

                                                @endif
                                                @endforeach">{{count($emp_leaves)}}</h5>
                                            </td>

                                            <!--<td><h5 class="mb-0">{{$proj->project_name}}</h5></td>
                                            <td><h5 class="mb-0">{{$emp_leaves}}</h5></td>  -->
                ...
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="card card-absolute">
                        <div class="card-header bg-primary">
                            <h5 class="text-white">Employees On Leave Today</h5>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="list-group list-group-custom list-group-flush">
                                <div class="list-group-item d-flex align-items-center py-3">
                                    ...
                                    <div class="content">
                                        <h5 class="mb-0">Total Leave : {{$total_leave_count}}</h5>
                                    </div>
                                </div>
                                <div class="list-group-item d-flex align-items-center py-3">
                                    <div class="icon text-center me-3"><i class="fa fa-thumbs-up"></i></div>
                                    <div class="content">
                                        <h5 class="mb-0">Approved : {{$total_approved_leave_count}}</h5>
                                    </div>
                                </div>
                                <div class="list-group-item d-flex align-items-center py-3">
                                    <div class="icon text-center me-3"><i class="fa fa-pencil"></i></div>
                                    <div class="content">
                                        <h5 class="mb-0">Pending : {{$total_pending_leave_count}}</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="card card-absolute">
                        <div class="card-header bg-primary">
                            <h5 class="text-white">Number of Employees On Leave | {{\Carbon\Carbon::now()->format('M')}}</h5>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="list-group list-group-custom list-group-flush">
                                <div class="list-group-item d-flex align-items-center py-3">
                                    <div class="icon text-center me-3"><i class="fa fa-chevron-right"></i> </div>
                                    <div class="content">
                                        <h5 class="mb-0">10 Days & More Continously : {{$morethan_ten_days}} | {{$morethan_ten_days_percent}}% </h5>
                                    </div>
                                </div>
                                <div class="list-group-item d-flex align-items-center py-3">
                                    <div class="icon text-center me-3"><i class="fa fa-chevron-right"></i> </div>
                                    <div class="content">
                                        <h5 class="mb-0">5 to 9 Days : {{$five_nine_days}} | {{$five_nine_days_percent}}% </h5>
                                    </div>
                                </div>
                                <div class="list-group-item d-flex align-items-center py-3">
                                    <div class="icon text-center me-3"><i class="fa fa-chevron-right"></i></div>
                                    <div class="content">
                                        <h5 class="mb-0">2 to 5 Days : {{$two_five_days}} | {{$two_five_days_percent}}% </h5>
                                    </div>
                                </div>
                                <div class="list-group-item d-flex align-items-center py-3">
                                    <div class="icon text-center me-3"><i class="fa fa-chevron-right"></i></div>
                                    <div class="content">
                                        <h5 class="mb-0">Only today's : {{$single_day}} | {{$single_day_percent}}%</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xl-12 col-md-6 col-12">
                    <div class="card card-absolute">
                        <div class="card-header bg-primary">
                            <h5 class="text-white">Team Attendance | {{\Carbon\Carbon::now()->format('d-m-Y')}}</h5>
                        </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        <thead class="table-primary">
                                            <tr>
                                                <th scope="col">My Teams</th>
                                                <th scope="col">Total Employees</th>
                                                <th scope="col">Marked Attendance</th>
                                                <th scope="col">On Leave Today</th>
                                                <th scope="col">Not Marked Attendance</th>
                                            </tr>
                                        </thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <!--Emp marked attendance-->

                                                @foreach($emp_attendance as $key => $emp_attend)
                                                ...
                                                <td>
                                                    ...
                                                    <div class="collapse" id="collapseExample{{$i}}">
                                                        @foreach($emp_attend as $attend)

                                                        <ul>
                                                            <li>{{$attend->finduser->name}} {{$attend->finduser->last_name}}</li>
                                                        </ul>
                                                        @endforeach
                                                    ...
                                                    <!-- <h5 class="mb-0 example-popover" data-bs-trigger="hover" data-container="body" data-bs-toggle="popover" data-bs-placement="top" data-offset="-20px -20px" data-bs-content="@foreach($emp_attend as $attend)                                                
                                                {{$attend->finduser->name}},                                               
                                                @endforeach">{{count($emp_attend)}}</h5>-->
                                                </td>
                                                @break
                                                @endif
                                                @endforeach
                                                ...
                                                <td>
                                                    ...
                                                    <div class="collapse" id="collapseExample{{$i}}">
                                                        ...
                                                        <ul>
                                                            <li>{{$leaves->user->name}} {{$leaves->user->last_name}}</li>
                                                        </ul>
                                                        @endforeach
                                                    ...
                                                    @endphp
                                                    <!--<h5 class="mb-0 example-popover" data-bs-trigger="hover" data-container="body" 
                                                    data-bs-toggle="popover" data-bs-placement="top" data-offset="-20px -20px" data-bs-content="@foreach($emp_leaves as $leaves)                                                
                                                {{$leaves->user->name}},                                               
                                                @endforeach">{{count($emp_leaves)}} </h5>-->
                                                </td>
                                                @break
                                                ...
                                                @foreach($emp_not_logged_attendance as $key => $emp_not_logged)
                                                @if($proj->id == $key)
                                                <td>
                                                    <h5>
                                                        <a data-bs-toggle="collapse" href="#collapseExample{{$i}}" role="button" aria-expanded="false" aria-controls="collapseExample{{$i}}">
                                                            {{count($emp_not_logged)}}
                                                        </a>
                                                    </h5>
                                                    <div class="collapse" id="collapseExample{{$i}}">
                                                        @foreach($emp_not_logged as $not_logged)

                                                        <ul>
                                                            <li>{{$not_logged->user->name}} {{$not_logged->user->last_name}}</li>
                                                        </ul>
                                                        @endforeach
                                                    ...
                                                    @endphp
                                                    <!--<h5 class="mb-0 example-popover" data-bs-trigger="hover" data-container="body"
                                                     data-bs-toggle="popover" data-bs-placement="top" data-offset="-20px -20px"
                                                      data-bs-content="@foreach($emp_not_logged as $not_logged)                                                
                                                {{$not_logged->user->name}},                                               
                                                @endforeach">{{count($emp_not_logged)}}</h5>-->
    ...
    <div class="container-fluid crypto-dash" id="hide">
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-md-12 col-lg-12  box-col-12">
                <div>
                    <div class="card">
        ...
        $(".nav-toggle").click(function() {
            ...
            $(collapse_content_selector).toggle(function() {
                if ($(this).css("display") == "none") {
                    ...
                    toggle_switch.html("Show Organization Dashboard");
                } else {
                    //change the button label to be 'Hide'
                    document.getElementById("hide").style.display = "none";
                    toggle_switch.html("Show Employee Dashboard");
                }
            });
        });
    });
