                ...
                <div class="col-12 col-sm-6">
                    <ol class="breadcrumb">
                        <div class="btn-showcase">
                            ...
                            <button class="btn btn-outline-primary nav-toggle" type="button" href="#collapse1" data-bs-original-title="" title="" data-original-title="btn btn-info">Show Project Manager Dashboard</button>
        ...
        <div class="container-fluid crypto-dash">
            <div class="row">
                <div class="col-xl-8 col-md-6 col-12">
                    <div class="card card-absolute">
                        <div class="card-header bg-primary">
                            <h5 class="text-white">My Team Attendance | {{\Carbon\Carbon::now()->format('d-m-Y')}}</h5>
                        </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="card card-absolute">
                        <div class="card-header bg-primary">
                            <h5 class="text-white">Pending Team Leaves Approval | {{\Carbon\Carbon::now()->format('M')}}</h5>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                            <th scope="col">My Teams</th>
                                            <th scope="col">Leaves Approval Pending</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($project_list as $proj)
                                        <tr>
                                            @foreach($emp_leave_pending as $key => $emp_pending)
                                            @if($proj->id == $key)
                                            @if(count($emp_pending)>0)
                                            <th scope="row">{{$proj->project_name}}</th>
                                            <td>
                                                <h5>
                                                    <a data-bs-toggle="collapse" href="#collapseExample{{$i}}" role="button" aria-expanded="false" aria-controls="collapseExample{{$i}}">
                                                ...
                                                <div class="collapse" id="collapseExample{{$i}}">
                                                    @foreach($emp_pending as $leave_pending)

                                                    <ul>
                                                        <li>{{$leave_pending->user->name}}</li>
                                                    </ul>
                                                    @endforeach
        ...
        $(".nav-toggle").click(function() {
            ...
            $(collapse_content_selector).toggle(function() {
                if ($(this).css("display") == "none") {
                    ...
                    toggle_switch.html("View As Project Manager");

                } else {
                    //change the button label to be 'Hide'
                    document.getElementById("hide").style.display = "none";
                    toggle_switch.html("View As Employee");
                }
            });
        });
    });
